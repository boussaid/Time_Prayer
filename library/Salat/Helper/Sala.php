...
class Salat_Helper_Sala
{
    ...
    {
        $AsrArc = ACOS(
                (SIN((90 - $AsrAlt) * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS(
                        $Dec * $pi / 180
                    ) * COS($lat * $pi / 180))
            ) * 180 / $pi / 15;
    ...
    {
        $AsrArc2 = ACOS(
                (SIN((90 - $AsrAlt2) * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS(
                        $Dec * $pi / 180
                    ) * COS($lat * $pi / 180))
            ) * 180 / $pi / 15;
    ...
    {
        $Durinal_Arc = Acos(
                (SIN(-0.8333 * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS(
                        $Dec * $pi / 180
                    ) * COS($lat * $pi / 180))
            ) * 180 / $pi;
    ...
    {
        $Esha_Arc = Acos(
                (SIN(-17 * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS($Dec * $pi / 180) * COS(
                        $lat * $pi / 180
                    ))
            ) * 180 / $pi;
    ...
    {
        $Fajr_Arc = Acos(
                (SIN(-18 * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS($Dec * $pi / 180) * COS(
                        $lat * $pi / 180
                    ))
            ) * 180 / $pi;
    ...
    {
        $imsak_Arc = Acos(
                (SIN(-20 * $pi / 180) - SIN($Dec * $pi / 180) * SIN($lat * $pi / 180)) / (COS($Dec * $pi / 180) * COS(
                        $lat * $pi / 180
                    ))
            ) * 180 / $pi;
    ...
    {
        $time = timezone_offset_get(new DateTimeZone($offset), new DateTime());
        return sprintf( "%s%02d:%02d", ( $time >= 0 ) ? '+' : '-', abs( $time / 3600 ), abs( $time % 3600 ) );
    }
}